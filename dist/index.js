        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    _d.trys.push([2, 4, , 5]);
                    params = "";
                    args = core.getInput('buildargs').replace(' ', '').split(',');
